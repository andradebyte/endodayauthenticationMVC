...
import { loginAuth, verificarTokenEmailAuth, verificarTokenSenhaAuth, criarTokenEmailAuth, criarTokenSenhaAuth, validarToken } from '../controllers/authController.js';
import { autenticarJWT } from "../middleware/autenticarJWT.js";

const router = express.Router();

router.get('/validar-token', autenticarJWT, validarToken)
